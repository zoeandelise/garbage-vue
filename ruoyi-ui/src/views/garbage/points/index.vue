<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="pointsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="积分变动" align="center" prop="pointsChange" width="100">
      ...
      <el-table-column label="类型" align="center" prop="pointsType" width="100">
        <template slot-scope="scope">
      ...
      <el-table-column label="关联记录" align="center" prop="referenceId" width="180" :show-overflow-tooltip="true" />
...
export default {
  ...
  methods: {
    ...
    handleView(row) {
      ...
      this.$router.push({ path: `/garbage/points/detail/${id}` });
    }
  }
};
</script> 